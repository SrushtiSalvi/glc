...
const SinglePostOld = () => {
  ...
  return (
    <div className="bg-gray-100 flex w-full">
      <div className="flex flex-col order-2 m-5">
      ...
      <div className="flex p-8 border shadow-xl order-1 bg-white lg:w-2/3 mx-8 h-full rounded-lg m-5">
