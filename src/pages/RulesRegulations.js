    ...
    <div className="m-8">
      ...
      <section className="p-4">
        <ul className="list-decimal space-y-4">
          ...
          <li>
            The CVs (Curriculum Vitae) submitted by applicants should strictly
            adhere to the format prescribed by the Placement Committee (until
            mentioned otherwise). Otherwise, the application will be rejected.
            (http://128.199.16.77/wp-content/uploads/2015/09/New-Placement-CV-Format3.pdf)
          </li>
          <li>
            CVs once submitted cannot be modified. Deadlines for online notices
          ...
          <li>
            ...
            Associate, via Placement Committee, he/she shall not be eligible to
            apply for any other firm, with the immediate cancellation of all
            pending interviews.
          </li>
          <li>
          ...
          <li>
            ...
            Articled Clerk & Associate, he/she shall join the firm on the
            proposed date. Any change or rejection after confirmation should be
            communicated to Placement Committee well in advance. Also in case
            the student is not able to provide a satisfactory reason for the
            same, strict action will be taken against such a student.
          </li>
          <li>
            The selected candidates have the liberty to either accept or reject
            the offer. The candidate accepting or rejecting the offer has to
            give a formal confirmation of the same via a written formal
            statement and in case, the candidate rejects, he/she shall also
            state the reason for such denial of the offer. Once the offer is
            accepted, the acceptance cannot be revoked.
          </li>
          <li>
          ...
          <li>
            ...
            canceling their registration or delaying it.
          </li>
        </ul>
        ...
        <div>
          ...
          <ul className="list-decimal">
            <li>
              A fee of Rs. 450/- will be charged for each Placement Week for
              which a receipt will be issued.
            </li>
            <li>No other fees shall be charged for the academic year.</li>
            <li>The above fee is non-refundable.</li>
          </ul>
        </div>
      </section>
    </div>
