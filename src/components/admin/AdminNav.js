...
const AdminNav = () => {
    return (
        <div className='flex justify-end bg-white shadow-lg w-full h-16 sticky top-0'>
            <div className='flex space-x-2 my-auto mr-16 border border-gray-600 rounded-md  bg-white hover:bg-gray-100 hover:cursor-pointer py-1 px-4'>
                <Menu >
                    <Menu.Button className='my-auto flex flex-row space-x-2'> <ImUser className='my-auto' />
                        <p className='my-auto'> Admin </p>
                        <IoIosArrowDown className='my-auto' /></Menu.Button>
                    <Transition
                        as={Fragment}
