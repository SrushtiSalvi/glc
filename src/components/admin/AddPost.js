      ...
      <div className="md:grid md:auto-rows-auto m-8 sm:flex sm:flex-row md:grid-cols-2 place-items-center w-3/4 mx-auto bg-white px-10 shadow-xl rounded-lg py-6">
        ...
        <div class="flex mx-auto w-full justify-center">
          <div className=" flex flex-col w-full my-4">
            <label
              class=" text-gray-700 text-md font-bold place-self-start"
              htmlFor="postType"
            >
              Post Type
            </label>
            <input
              class="block  bg-white text-gray-700 border border-gray-500 w-11/12 rounded py-2 px-4 my-2"
              id="postType"
              type="text"
        ...
        <div class="flex mx-auto w-full col-span-2 justify-center">
          <div className=" flex flex-col w-full my-4">
            <label
              class="text-gray-700 text-md font-bold place-self-start"
              htmlFor="content"
