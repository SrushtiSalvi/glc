          ...
          <div className="space-y-5 p-4 text-xs flex-row">
            ...
            <div className="space-y-5 p-4 text-xs flex-row">
              ...
              <p>
                ...
                recruitment with law firms, counsels, LPOs and corporate
                houses. It acts as a link between the recruiters and the
                students, thereby fulfilling the needs of both, and enabling
                the students to get placements on campus. The members of the
                Placement Committee strive hard to ensure that maximum students
                from the college get placements, thus providing them with an
              ...
              <p>
                ...
                Committee is sure to benefit both the students and the
                potential employers.
              </p>
              <p>
